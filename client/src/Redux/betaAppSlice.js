  ...
  async (betaApp) => {
    try {
      ...
      const { data } = await axios.post(
        `${import.meta.env.VITE_BACK_URL}/betaApp`,
        betaApp
      );
      return data;
    } catch (error) {
...
export const getmyBetaApp = createAsyncThunk("beta/myBetaApp", async () => {
  try {
    ...
    const { data } = await axios.get(
      ...
      `${import.meta.env.VITE_BACK_URL}/betaApp/myapp`
    );
    return data;
  } catch (error) {
    console.log(error);
...
export const acceptBetaApp = createAsyncThunk("beta/acceptApp", async (id) => {
  try {
    ...
    const { data } = await axios.put(
      `${import.meta.env.VITE_BACK_URL}/betaApp/accept/${id}`
    );
    return data;
  } catch (error) {
    console.log(error);
...
export const rejectBetaApp = createAsyncThunk("beta/rejectApp", async (id) => {
  try {
    ...
    const { data } = await axios.put(
      `${import.meta.env.VITE_BACK_URL}/betaApp/reject/${id}`
    );
    return data;
  } catch (error) {
    console.log(error);
